...
jQuery(document).on('ready', function() {
	...
	/* ---------------------------------------
			SIGN IN OPEN CLOSE
	--------------------------------------- */
	// jQuery('a[href="login/index.html"]').on('click', function(event) {
	// 	event.preventDefault();
	// 	jQuery('login/index.html').addClass('open');
	// 	jQuery('body').addClass('tg-hidescroll');
	// });
	// jQuery('login/index.html, login/index.html button.close').on('click keyup', function(event) {
